...
public class CreateCountry {
	...
	static List<String> countries = Arrays.asList("Afghanistan", "Åland Islands", "Albania", "Algeria",
			...
			"British Indian Ocean Territory", "United States Minor Outlying Islands", "Virgin Islands (British)",
			"Virgin Islands (U.S.)", "Brunei Darussalam", "Bulgaria", "Burkina Faso", "Burundi", "Cambodia", "Cameroon",
			"Canada", "Cabo Verde", "Cayman Islands", "Central African Republic", "Chad", "Chile", "China",
			...
			"Viet Nam", "Wallis and Futuna", "Western Sahara", "Yemen", "Yugoslavia", "Zambia", "Zair", "Zimbabwe");
